package com.f55119042.maryamgithubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List of GitHub Users | F55119042");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
